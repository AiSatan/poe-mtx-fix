...
<img width="605" height="620" alt="image" src="https://github.com/user-attachments/assets/12f755b4-cf61-4abb-9df5-a54dc90709ba" />


Download ```poe2_production_Loaded.mtx``` in Release folder and replace this file here: ```/Documents/My Games/Path of Exile 2/poe2_production_Loaded.mtx``` with [the file you have downloaded](https://github.com/AiSatan/poe-mtx-fix/blob/main/poe2_production_Loaded.mtx) (or just open it in the notepad and replace the content)
